...
const Deals = () => {
  return (
    <div>
      <div
        id="heroProducts"
        className="grid grid-cols-[repeat(auto-fit,minmax(20rem,1fr))] my-5 gap-[2rem] max-sm:my-1 max-sm:gap-1 place-items-center"
      >
        ...
        <div className="productBox">
          ...
          <img src={Product[1]} alt="" className="" />
          <a>Shop gaming</a>
        </div>
        <div className="productBox">
        ...
        <div className="productBox">
          ...
          <div className="productGrid">
            ...
            <div className="productItem">
              <img src={Product[11]} alt="" />
              <p>Tops under $25</p>
            </div>
            <div className="productItem">
              <img src={Product[12]} alt="" />
              <p>Dresses under $30</p>
            </div>
            <div className="productItem">
              <img src={Product[13]} alt="" />
              <p>Shoes under $50</p>
            </div>
          </div>
          <a>See all deals</a>
        ...
        <div className="productBox">
          ...
          <div className="productGrid">
            <div className="productItem">
              <img src={Product[14]} alt="" />
              <p>Kitchen & dining</p>
            </div>
            <div className="productItem">
              <img src={Product[15]} alt="" />
              <p>Home improvement</p>
            </div>
            <div className="productItem">
              <img src={Product[16]} alt="" />
              <p>Decor</p>
            </div>
            <div className="productItem">
              <img src={Product[17]} alt="" />
              <p>Bedding & bath</p>
            </div>
          </div>
        ...
        <div className="productBox">
          ...
          <img src={Product[18]} alt="" className="" />
          <a>Shop now</a>
        </div>
        <div className="productBox">
          <h1>Up to 75% off | Headphones</h1>
          <img src={Product[19]} alt="" className="" />
          <a>Shop now</a>
        </div>
      </div>
    </div>
